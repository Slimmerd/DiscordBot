...
if (typeof ShuffleYTPlaylists !== 'boolean') {
    ShuffleYTPlaylists = false;
}
if (typeof playVideosLongerThanHour !== 'boolean') {
    playVideosLongerThanHour = false;
}
...
module.exports = class PlayCommand extends Command {
    ...
    async run(message, {query}) {
                    ...
                    .then(async function onClarifyResponse(response) {
                        ...
                        if (msgContent == 1) {
                            ...
                            if (message.guild.musicData.isPlaying) {
                                ...
                                await PlayCommand.createResponse(message)
                                    .addField(
                                        'Added Playlist',
        ...
        if (
            ...
            if (video.duration.hours !== 0 && !playVideosLongerThanHour) {
                return message.reply(
